        ...
        <div className="sticky top-0 z-10 bg-white border-b border-border">
          <div className="px-5 py-4 flex items-center justify-between">
            ...
            <button
              ...
              disabled={isSaving}
              className="px-4 py-2 bg-secondary text-white rounded-full font-medium text-sm hover:bg-secondary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {isSaving ? (
                <>
